...
prefix2 = ['Sp4b6.5nF2nAS3mF-0.71mAS-1.01T48L20', 'Sp4b6.5nF2nAS3mF-0.71mAS-1.01T64L20', 'Sp4b6.5nF2nAS3mF-0.71mAS-1.01T96L20', 'Sp4b6.5nF2nAS3mF-0.7mAS-1.01T64L20', 'Sp4b6.5nF2nAS3mF-0.72mAS-1.01T64L32']
...
for n in range(3):
    ...
    for index, ensemble in enumerate(ensembles):
        ...
        with open(f'./assets/tables/{ensemble}_output_table_aE{n}_meson.tex', 'w') as file:
